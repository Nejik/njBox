    ...
    prototype: {
      _gallery_init: function _gallery_init() {
        ...
        this.on('listeners_added', function () {
          ...
          this.dom.wrap.delegate('[data-njb-prev]', 'click', h.wrap_prev).delegate('[data-njb-next]', 'click', h.wrap_next);
        });
      ...
      _g_inQueue: function _g_inQueue(item) {},
      _g_createDom: function _g_createDom() {
        var dom = {},
            o = this.o,
            $ = this.$;
      ...
      _g_makeUnfocusable: function _g_makeUnfocusable(el, selector) {
        var $ = this.$,
            wrap = $(el),
            focusable,
            history = [];
      ...
      _g_restoreUnfocusable: function _g_restoreUnfocusable(obj) {
        var item = obj.item,
            tabs = obj.tabs,
            dom;
      ...
      _g_preload: function _g_preload() {
        var o = this.o,
            that = this;
      ...
      _g_drawItemSiblings: function _g_drawItemSiblings() {
        var o = this.o,
            that = this;
      ...
      _g_moveItem: function _g_moveItem(item, value, unit) {
        unit = unit || 'px';
      ...
      _g_changeItem: function _g_changeItem(nextIndex, dir) {
      ...
      _g_detectIndexForOpen: function _g_detectIndexForOpen() {
        var that = this,
            o = this.o,
            $ = this.$,
        ...
        if (typeof indexFromArgument === 'string') {
          //show argument can be a string
          indexFromArgument = parseInt(indexFromArgument);
        } else if ($.isPlainObject(indexFromArgument)) {
          //or argument can be an object with index value
      ...
      _g_setQueue: function _g_setQueue(currentIndex) {
      ...
      _g_getItemsOrder: function _g_getItemsOrder(index) {
        var o = this.o,
            prev = index - 1,
            next = index + 1;
      ...
      _g_getQueueItem: function _g_getQueueItem(index) {
        var item;
      ...
      _g_uiUpdate: function _g_uiUpdate() {
      ...
      _g_gatherElements: function _g_gatherElements(selector) {
        if (selector) {
