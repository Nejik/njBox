...
(function () {
  if (window.njBox) njBox.addAddon('gallery', {
    ...
    prototype: {
      ...
      _makeUnfocusable: function _makeUnfocusable(el, selector) {
        var wrap = this.$(el),
            focusable,
            history = [];
      ...
      _restoreUnfocusable: function _restoreUnfocusable(obj) {
        var item = obj.item,
            tabs = obj.tabs,
            dom;
      ...
      _changeItem: function _changeItem(nextIndex, dir) {
      ...
      _setQueue: function _setQueue(currentIndex) {
      ...
      _gatherElements: function _gatherElements(selector) {
        if (selector) {
